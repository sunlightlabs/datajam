...
b.content_updates.length&&(this.view.contentUpdates.add(b.content_updates),delete b.content_updates);return b},toJSON:function(b){b=Backbone.Model.prototype.toJSON.call(this,b);return _.extend(b,{content_areas:this.view.contentAreas.toJSON()})}})});var k=window;e("datajam/models/content_area",["datajam/init"],function(){k.Datajam.models.ContentArea=Backbone.Model.extend({})});var l=jQuery,m=window;e("datajam/models/content_update",["datajam/init"],function(){var c=m.Datajam;c.models.ContentUpdate=
...
a.get("area_type")+"_"+a.id),model:a,collection:e})).render()},this));return this},initializeModals:function(){_.each(this.contentAreas.models,_.bind(function(a){var b=a.get("modal_class");h([_.pathify(b)],_.bind(function(){var c=_.constantize(b);a.modal=new c({el:d('<div id="modal-'+a.id+'" class="modal hide fade" style="display: none;">'),model:a});d("body").append(a.modal.el);a.modal.render();a.modal.$el.modal({backdrop:false,show:false})},this))},this));return this},initializeReminder:function(){var a=
this.model.get("unix_scheduled_at"),b=(new Date).getTime()/1E3;if(a>b){d("#event_reminder").show();d("#event_reminder form").on("ajax:success",function(a,b){d(this).find(".response").text(b.message).attr({"class":"alert alert-"+b.type}).fadeIn().delay(5E3).fadeOut();d(this).find("input[name=email]").val("")})}},pollForUpdates:function(){this.contentUpdates.fetch({add:true});setTimeout(_.bind(this.pollForUpdates,this),Datajam.settings.interval);return this},pollForAudience:function(){if(!b.settings.CHARTBEAT_API_KEY){this.$el.find("li.audience").hide();
return this}d.ajax({url:"//api.chartbeat.com/live/quickstats/v3/",dataType:"jsonp",jsonp:"jsonp",callback:"?",data:{apikey:b.settings.CHARTBEAT_API_KEY,host:location.hostname,path:location.pathname}}).then(_.bind(function(a){this.$el.find("li.audience .badge").html(a.people)},this));setTimeout(_.bind(this.pollForAudience,this),3E4);return this},remove:function(){d(g).off("keydown.datajam");BackboneView.prototype.remove.call(this)},renderToolbar:function(){b.templates.onairToolbar||(b.templates.onairToolbar=
Handlebars.compile(c));this.$el.html(b.templates.onairToolbar(this.model.toJSON())).children().eq(0).addClass("topbarred");return this},toggleModal:function(a){d("div.modal[id^=modal]").not("#"+a).trigger("hide");d(a).trigger("toggle");return this}})});var r=jQuery;h(["datajam/init","datajam/views/event"],function(){var c=r("body").prepend('<div class="datajam-event" />').find(".datajam-event");Datajam.event=new Datajam.views.Event({el:c})})})(jQuery,define,require);
