...
BackboneView.prototype.remove.call(this)},renderToolbar:function(){b.templates.onairToolbar||(b.templates.onairToolbar=Handlebars.compile(c));this.$el.html(b.templates.onairToolbar(this.model.toJSON()));d("body").addClass("topbarred");return this},toggleModal:function(a){d("div.modal[id^=modal]").not("#"+a).trigger("hide");d(a).trigger("toggle");return this}})});var s=jQuery;h(["datajam/init","datajam/views/event"],function(){if(!Datajam.eventId)return!1;var c=s("body").prepend('<div class="datajam-event" />').find(".datajam-event");
