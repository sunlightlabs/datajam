...
return this},pollForAudience:function(){if(!b.settings.chartbeat_api_key)return this.$el.find("li.audience").hide(),this;d.ajax({url:"//api.chartbeat.com/live/quickstats/v3/",dataType:"jsonp",jsonp:"jsonp",callback:"?",data:{apikey:b.settings.chartbeat_api_key,host:location.hostname,path:location.pathname}}).then(_.bind(function(a){this.$el.find("li.audience .badge").html(a.people)},this));setTimeout(_.bind(this.pollForAudience,this),3E4);return this},remove:function(){d(g).off("keydown.datajam");
BackboneView.prototype.remove.call(this)},renderToolbar:function(){b.templates.onairToolbar||(b.templates.onairToolbar=Handlebars.compile(c));this.$el.html(b.templates.onairToolbar(this.model.toJSON()));d("body").addClass("topbarred");return this},toggleModal:function(a){d("div.modal[id^=modal]").not("#"+a).trigger("hide");d(a).trigger("toggle");return this}})});var s=jQuery;h(["datajam/init","datajam/views/event"],function(){var c=s("body").prepend('<div class="datajam-event" />').find(".datajam-event");
